...
export default async function HomePage() {
  // --- FIX 2 & 3: Fetch two different datasets for variety and correct logic ---
  const [trendingItems, newestItems] = await Promise.all([
    // Fetch top 12 most popular items for the carousel
    ...
    // Fetch 20 newest items for the masonry grid
    db.contributorItem.findMany({
      where: { status: "APPROVED" },
  ...
  // Ensure you pass the correct items to the carousel
  // Note: Also ensure your SimpleCarousel component uses `item.previewUrl` for performance!
  const carouselItems: DisplayItem[] = trendingItems;

  return (
    <div className="min-h-screen bg-gray-950">
      {/* Hero Section (No changes needed here, it's great) */}
      ...
      {/* Popular Resources -> Changed to Newest Resources for variety */}
