        ...
        <div className="flex-1 p-4">
          ...
          <div className="mb-6 flex flex-wrap justify-between items-center">
            ...
            <div className="text-gray-400 text-sm">
              {totalItems} PNG {totalItems === 1 ? 'image' : 'images'} found
            </div>
          </div>
          ...
          {approvedItems.length === 0 ? (
            <div className="flex flex-col items-center justify-center bg-gray-900/30 border border-gray-800/50 rounded-xl p-12 mt-10">
              <div className="text-xl text-gray-400 mb-4">No PNG images found</div>
              <div className="text-gray-500">Try adjusting your filters or search query</div>
              <Link href="/pngs" className="mt-6 px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors">
                Clear filters
              </Link>
            </div>
          ) : (
